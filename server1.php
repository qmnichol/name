...
if(isset($_POST["register"])){
	...
	if ($usertype=="employee") {
		...
		if($result->num_rows > 0){
			...
			unset($_SESSION["errorMsg2"]);
			$sql = "INSERT INTO employerr (username, profilepic, fname, mname, lname, Email, Gender, Age, Bdate, mnumber, zipcode, city, province, validID, password, address, NC, skill, education, experience, proTitle) VALUES ('$username', '$profilepic', '$fname', '$mname', '$lname', '$Email', '$Gender', '$Age', '$Bdate', '$mnumber', '$zipcode', '$city', '$province', '$validID', '$password', '$address', '$NC', '$skill', '$education', '$experience', '$proTitle')";
			$result = $conn->query($sql);
			if($result==true){
				$_SESSION["Username"]=$username;
				$_SESSION["Usertype"]=2;
