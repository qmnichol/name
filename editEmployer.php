...
if(isset($_POST["SaveChanges"])){
	...
	$sql = "UPDATE employer SET fname='$fname', mname='$mname', lname='$lname', Email='$Email', Bdate='$Bdate', mnumber='$mnumber', address='$address', zipcode='$zipcode', city='$city', province='$province' WHERE username='$username'";
        ...
        <div class="container"><a class="navbar-brand logo" href="employeeProfile.php">Service Finder <small>for Irosin Sorsogon</small></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <br>
					<li class="nav-item" role="presentation"><a class="nav-link" href="employeeProfile.php">   <?php echo $username; ?></a></li>
    ...
    <div id="profile" class="modal animated rubberBand delete-modal" role="dialog">
         <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <form action="editEmployerProfile.php" method="POST">
