...
<body class="body bg-dark">
  <div class="login-box" style="width: 30%;margin-left: 35%;margin-top: 100px;margin-bottom: 20px;">
    <div class="card card-outline card-success">
      <div class="X" >
        <li class="nav" style="float: right; padding-right:10px"><a href="adminlogin.php"><span class="fa fa-times" style="color: black;"></span></a></li>
      </div>
      <!-- logo -->
        ...
        <form id="loginForm" method="post" class="form-horizontal">
          ...
          <div class="row">
            <div class="col-6 offset-4">
              <button type="submit" name="submit" class="btn ml-auto rounded-pill btn-font-size px-4" style="background: rgb(116, 156, 143);color:#fff;">Login</button>
            </div>
