...
if(isset($_POST["SaveChanges"])){
	...
	$sql = "UPDATE employer SET username='$username', password='$password', profilepic='$profilepic', fname='$fname', mname='$mname', lname='$lname', Email='$Email', Gender='$Gender', Bdate='$Bdate', mnumber='$mnumber', address='$address', zipcode='$zipcode', city='$city', province='$province', validID='$validID', NC='$NC', skill='$skill' WHERE username='$username'";
...
if (isset($_POST["Delete"])) {
    ...
    $sql = "DELETE FROM employer WHERE id = $accountid";
            ...
            <div class="card">
                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="form-horizontal">
                    ...
                    <?php
                            ...
                            $accountid = $_GET["id"];
                            $connection = mysqli_connect("localhost", "root", "", "service_finder");
                            $sql = "SELECT * FROM employer WHERE id = $accountid";
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                            <img src="../asset/img/<?php echo $row['NC']; ?>" name="NC" value="<?php echo $row['NC']; ?>" alt="" height="200" width="200"style="">
                                        </div>
                                    </div>
