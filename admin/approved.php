...
$number = $mnumber;
$api = "TR-SERVI770945_V3WRQ";
$text = $msg;

	$sql = "INSERT INTO employe (username, password, profilepic, fname, mname, lname, Email, Gender, Age, Bdate, mnumber, address, zipcode, city, province, validID) VALUES ('$username', '$password', '$profilepic', '$fname', '$mname', '$lname', '$Email', '$Gender', '$Age', '$Bdate', '$mnumber', '$address', '$zipcode', '$city', '$province', '$validID')";
    $result = $conn->query($sql);
    if($result==true){
        $result1 = itexmo($number,$text,$api);
        if ($result == ""){
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-9 col-sm-offset-3">
                                            ...
                                            <button type="submit" name="approve" class="btn btn-info btn-lg">Approve</button>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="number" id="" value="<?php echo $row['mnumber']; ?>">
                                        <input type="text" name="msg" id="" value="Hi! You are now registered on SERVICE FINDER IROSIN SORSOGON.">
                                        <input type="text" name="text1" id="" value="Your registration on SERVICE FINDER IROSIN SORSOGON is rejected. Please try agin.">
                                    </div>
                                </div>
                            </div>
