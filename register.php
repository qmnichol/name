  ...
  <section class="content">
    <div class="container">
      ...
      <div class="card">
        ...
        <h2><center>Employee Registration Form</center></h2>
              ...
              <div class="col-md-3">
                <div class="form-group text-center" >
                  <span class="img-div">
                    ...
                    <img src="asset/img/beard.png" onClick="triggerClick()" id="profileDisplay" style="width: 150px; height: 150px" class="img rounded-circle" alt="profile">
                  </span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="skill" required="require" value="<?php echo $skill; ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="card-header">
                      <span class="fa fa-key"> Valid ID Valid ID <small>(National ID, Brgy ID, Student ID)</small></span>
                    </div>
                    <div class="form-group">
